      ...
      <div className="gig">
        <div className="containergig">
          <div className="leftgig">
            <span className="breadcrumbsgig">Liverr Graphics & Design </span>
            ...
            <div className="seller">
              ...
              <div className="box">
                <div className="itemsgig">
                  <div className="itemgig">
                    <span className="titlegig">From</span>
                    <span className="descgig">USA</span>
                  </div>
                  <div className="item">
                  ...
                  <div className="itemgig">
                    <span className="titlegig">Avg. response time</span>
                    <span className="descgig">4 hours</span>
                  </div>
                  <div className="itemgig">
                    <span className="titlegig">Last delivery</span>
                    <span className="descgig">1 day</span>
                  </div>
                  <div className="itemgig">
                    <span className="titlegig">Languages</span>
                    <span className="descgig">English</span>
                  </div>
                </div>
                <hr />
                <p>
